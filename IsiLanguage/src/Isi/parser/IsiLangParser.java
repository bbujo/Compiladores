	...
	public final CmdContext cmd() throws RecognitionException {
		...
		try {
			...
			case T__8:
				...
				setState(73);
				cmdIf();
				 System.out.println("Comando de decisao computado");
				}
				break;
			case T__11:
				...
				setState(76);
				cmdSwitch();
				 System.out.println("Comando de desisao: Switch computado");
				}
				break;
			case T__16:
				...
				setState(79);
				cmdWhile();
				 System.out.println("Comando de repeticao computado");
				}
				break;
			case ID:
				...
				setState(82);
				cmdExpr();
				 System.out.println("Comando de atribuicao computado");
				}
				break;
			default:
				throw new NoViableAltException(this);
