...
cmd		: cmdLeitura { System.out.println("Comando de leitura computado");}
		...
		| cmdIf		 { System.out.println("Comando de decisao computado");}
		| cmdSwitch	 { System.out.println("Comando de desisao: Switch computado");}
		| cmdWhile	 { System.out.println("Comando de repeticao computado");}
		| cmdExpr	 { System.out.println("Comando de atribuicao computado");}
		;
